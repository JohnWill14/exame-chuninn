...
public class ModelosController {
    ...
    @Autowired
    public ModelosController(ModeloVeiculoService modeloVeiculoService) {
    ...
    public String update(@PathVariable("id") long id, Model update) {
        ModeloVeiculo tipo = null;
        try {
            tipo = modeloVeiculoService.getById(id);
        } catch (Exception ex) {
    ...
    public String remove(@PathVariable("id") long id) {
        ...
        try {
            ...
            return "redirect:/adm/modelo/index/4";
        }
        return "redirect:/adm/modelo/index/3";
    }
